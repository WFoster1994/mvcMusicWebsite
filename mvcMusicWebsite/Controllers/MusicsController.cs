...
namespace mvcMusicWebsite.Controllers
{
    public class MusicsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MusicID,BandName,Price,AlbumName,TrackName,ArtistName,Description,ImageURL,Rating")] Music music)
        {
